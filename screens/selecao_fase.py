...
def selecao_carro():
    ...
    while running:
        ...
        hamburguer = pygame.image.load("assets/hamburguer_normal.png")
        botao_hamburguer = Button(image=jogador.mostra_imagem(hamburguer), pos=(SCREEN_WIDTH*2 / 3 + 100, 400), text_input="")
        hotdog = pygame.image.load("assets/hotdog_normal.png")
        ...
        botao_donut = Button(image=jogador.mostra_imagem(donut), pos=(SCREEN_WIDTH / 3 - 100, 400), text_input="") 
        ...
        botao_voltar = Button(image=None, pos=(SCREEN_WIDTH / 2, 650), text_input="VOLTAR")
