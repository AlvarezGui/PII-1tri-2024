...
class Cadastro():
    ...
    def run(self):
        texto = customtkinter.CTkLabel(janela, text="Validar Cadastro")
        ...
        entrar = customtkinter.CTkButton(janela, text="Entrar", command=self.validar_usuario(email, senha))

        texto.pack(padx = 10, pady = 10)
        email.pack(padx = 10, pady = 10)
        senha.pack(padx = 10, pady = 10)
        entrar.pack(padx = 10, pady = 10)
        janela.mainloop()
